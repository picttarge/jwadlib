...
/**
 * The parent {@link java.lang.Exception exception} of WAD format problems.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class WADFormatException extends Exception {
    /**
     ...
     * @since 1.0
     */
    public WADFormatException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public WADFormatException(String message, Throwable cause) {
        super(message, cause);
    }
}