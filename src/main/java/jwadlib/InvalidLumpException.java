...
/**
 * Signals that there is an error with a lump in the WAD file being processed.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class InvalidLumpException extends WADFormatException {    
    /**
     * Constructs an {@link java.lang.Exception Exception} without a message 
     * or a {@link java.lang.Throwable Throwable} cause.
     * @since 1.0
     */
    public InvalidLumpException() {
        super();
    }
     ...
     * @since 1.0
     */
    public InvalidLumpException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public InvalidLumpException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public InvalidLumpException(String message, Throwable cause) {
        super(message, cause);
    }
}