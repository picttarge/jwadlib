/*
 * InvalidWADHeaderException.java
...
/**
 * Signals that there is an error with the first twelve bytes of the WAD file 
 * being processed.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @see InvalidWADIdentifierException
 * @since 1.0
 */
public class InvalidWADHeaderException extends WADFormatException {    
    /**
     ...
     * @since 1.0
     */
    public InvalidWADHeaderException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public InvalidWADHeaderException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public InvalidWADHeaderException(String message, Throwable cause) {
        super(message, cause);
    }
}