/*
 * UnableToReadWADFileException.java
...
public class UnableToReadWADFileException extends WADFormatException {    
     ...
     * @since 1.0
     */
    public UnableToReadWADFileException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public UnableToReadWADFileException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public UnableToReadWADFileException(String message, Throwable cause) {
        super(message, cause);
    }
}