/*
 * UnableToReadLumpFileException.java
...
/**
 * Signals that the lump file is unable to be read.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class UnableToReadLumpFileException extends WADFormatException {    
    /**
     * Constructs an {@link java.lang.Exception Exception} without a message 
     * or a {@link java.lang.Throwable Throwable} cause.
     * @since 1.0
     */
    public UnableToReadLumpFileException() {
        super();
    }
     ...
     * @since 1.0
     */
    public UnableToReadLumpFileException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public UnableToReadLumpFileException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public UnableToReadLumpFileException(String message, Throwable cause) {
        super(message, cause);
    }
}