/*
 * InvalidWADIdentifierException.java
...
/**
 * Signals that there is an error with the first four bytes of the WAD file 
 * being processed.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class InvalidWADIdentifierException extends InvalidWADHeaderException {    
    /**
     * Constructs an {@link java.lang.Exception Exception} without a message 
     * or a {@link java.lang.Throwable Throwable} cause.
     * @since 1.0
     */
    public InvalidWADIdentifierException() {
        super();
    }
     ...
     * @since 1.0
     */
    public InvalidWADIdentifierException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public InvalidWADIdentifierException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public InvalidWADIdentifierException(String message, Throwable cause) {
        super(message, cause);
    }
}