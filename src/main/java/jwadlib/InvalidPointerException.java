...
/**
 * Signals that there is an error with a pointer in the WAD file being processed.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class InvalidPointerException extends WADFormatException {    
    /**
