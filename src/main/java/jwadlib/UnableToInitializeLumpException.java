/*
 * UnableToWriteWADFileException.java
...
/**
 * Signals that the WAD file is unable to be initialized.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class UnableToInitializeLumpException extends Exception {    
    /**
     * Constructs an {@link java.lang.Exception Exception} without a message 
     * or a {@link java.lang.Throwable Throwable} cause.
     * @since 1.0
     */
    public UnableToInitializeLumpException() {
        super();
    }
     ...
     * @since 1.0
     */
    public UnableToInitializeLumpException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public UnableToInitializeLumpException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public UnableToInitializeLumpException(String message, Throwable cause) {
        super(message, cause);
    }
}