 ...
 * @since 1.0
 */
public class UnableToWriteWADFileException extends WADFormatException {    
    /**
     ...
     * @since 1.0
     */
    public UnableToWriteWADFileException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public UnableToWriteWADFileException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public UnableToWriteWADFileException(String message, Throwable cause) {
        super(message, cause);
    }
}