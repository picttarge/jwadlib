/*
 * InvalidWADDirectoryException.java
...
/**
 * Signals that there is an error with the directory structure in the WAD file 
 * being processed.
 * @author Samuel "insertwackynamehere" Horwitz
 * @version 1.0 Alpha 2
 * @since 1.0
 */
public class InvalidWADDirectoryException extends WADFormatException {    
    /**
     ...
     * @since 1.0
     */
    public InvalidWADDirectoryException(String message) {
        super(message);
    }
     ...
     * @since 1.0
     */
    public InvalidWADDirectoryException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.0
     */
    public InvalidWADDirectoryException(String message, Throwable cause) {
        super(message, cause);
    }
}